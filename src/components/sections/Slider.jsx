...
export default function Slider() {
  ...
  return (
    <section className="relative w-full h-[470px] max-w-7xl mx-auto overflow-hidden mt-[110px] rounded-[30px] shadow-[0_8px_30px_rgba(0,0,0,0.12)] bg-white/50 backdrop-blur-xl">
