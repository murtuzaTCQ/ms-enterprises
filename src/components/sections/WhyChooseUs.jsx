export default function WhyChooseUs() {
  ...
  return (
    <section className="py-20 bg-white text-center px-6" id="why-choose-us" aria-label="Why choose MS Enterprises for wholesale fashion">
      
      {/* Hidden SEO Text */}
      <div className="sr-only">
        Why choose MS Enterprises? Our wholesale women’s clothing is backed by premium fabric quality,
        fast pan-India shipping, in-house manufacturing, trusted bulk order support, the best pricing,
        ready stock availability, and instant customer support for retailers and boutique owners.
      </div>
